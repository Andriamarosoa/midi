...
class H24ScientificExecutionAuthorizationContractTests(unittest.TestCase):
    ...
    def test_contract_is_lf_contract_only_and_authorizes_no_science(self) -> None:
        ...
        self.assertEqual(self.contract["schema_version"], 10)
        self.assertEqual(
        ...
        self.assertEqual(
            self.contract["authorization_basis"]["evidence_producer_correction_authorized_action"],
        ...
        self.assertEqual(
            self.contract["authorization_basis"]["population_terminal_SHA_binding_correction_authorized_action"],
            "AUTHORIZED_TO_CORRECT_H24_PUBLISHED_POPULATION_TERMINAL_SHA_BINDING_AND_REBASE_DORMANT_AUTHORITY_BINDINGS_ONLY",
        )
        self.assertEqual(
            self.contract["status"],
            "published_population_terminal_SHA_binding_and_dormant_authority_bindings_corrected_external_review_required",
        )
    ...
    def test_future_capability_is_separate_nonconstructible_and_fail_closed(self) -> None:
        ...
        for binding in (
            "future_evidence_producer_source_blob",
    ...
    def test_future_seal_activation_and_all_scientific_rights_are_absent(self) -> None:
        ...
        self.assertTrue(seal["must_bind_evidence_producer_source_blob"])
