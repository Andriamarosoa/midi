...
class TestExecutionGateContract(unittest.TestCase):
 ...
 def test_exact_order_rules_state_and_edges(self):
  self.assertEqual(self.c['future_fail_closed_order'],['load_exact_execution_authority_artifact','verify_head_equals_expected_git_head','verify_worktree_clean','rehash_all_one_hundred_sixteen_predecessor_identities','open_persistent_registry','reserve_exact_artifact_id_and_nonce_once','consume_exact_execution_authority_artifact_atomically','invoke_exact_sealed_constructor_once'])
