...
class TestTargetCheckoutDetachRunner(unittest.TestCase):
    ...
    def test_exact_binding_boundary_and_dormant_state(self) -> None:
        ...
        self.assertEqual(self.binding["normative_transition_order"], [
            "verify_platform_and_zero_arguments", "verify_checkout_and_odb_realpaths",
            "verify_five_predecessor_identities", "verify_initial_head_exact",
            "verify_initial_worktree_clean", "verify_target_object_exists_and_type_is_commit",
    ...
    def test_exact_external_seal(self) -> None:
        self.assertEqual(self.seal, {
            ...
            "identity_binding": {"path": "configs/harmonic_censoring_h27_target_checkout_detach_runner_identity_binding.json", "git_blob_sha1": "09e26933b8ea1ba8eadaeea8f9e116fe08a1953a", "size_bytes": 4649, "raw_sha256": "23b370fedc5fce032b3fa694230cfe555cd993f2a8cd41a7f7ac6b5f3f40ac16"},
