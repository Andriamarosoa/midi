...
class TestRegistryFileCreator(unittest.TestCase):
    ...
    def test_exact_binding_order_contract_and_complete_seal(self) -> None:
        ...
        ordered = [
            ...
            "created_fd = os.open(", "os.fsync(created_fd)",
            "require_file_identity(parent_fd, created_fd)", "os.fsync(parent_fd)", "reopened_fd = os.open(",
        ...
        self.assertEqual(self.binding["creation_safeguards"], {
            ...
            "created_file_fsynced_before_created_fd_validation": True,
            "created_fd_then_verified_regular_nlink_one_size_zero_mode_0600": True,
            "parent_fsynced_after_created_fd_validation": True,
        ...
        self.assertEqual(self.seal, {
            ...
            "identity_binding": {"path": "configs/harmonic_censoring_h27_registry_file_creator_identity_binding.json", "git_blob_sha1": "f9378878bc60ecf2128753bfa08d2193d5efe70d", "size_bytes": 5816, "raw_sha256": "5521ac69fd021b79598f182e22f1ab9fc8a1894c7ed457e67ff320bd863bb38d"},
            "runner": {"path": "scripts/h27_create_empty_registry_file_one_shot.py", "git_blob_sha1": "bd8b42c4b6e047076f0cddaad3765899914900e2", "size_bytes": 11915, "raw_sha256": "380c1012e0bdac0b42e5b531b26a178100115158f482f0b81e3c4ebac0485dd5"},
    ...
    def test_synthetic_call_order_has_single_creation_effect(self) -> None:
        ...
        self.assertEqual(calls, ["identities", "environment", "open_parent", "probe", "parent", "create_open", "fsync", "verify_created", "fsync", "reopen", "verify_reopened", "parent", "close", "close", "close"])
