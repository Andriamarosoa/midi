...
class AdaptiveOnsetDetector:
    ...
    def __init__(
        ...
        self._continuity_reset_pending = False
    ...
    def reset_continuity(self) -> None:
        ...
        self.unarmed_peak_rms = 0.0
        self._has_previous_spectrum = False
        self._continuity_reset_pending = True
    ...
    def process(self, hop: np.ndarray) -> OnsetResult:
        ...
        if not self.armed:
            ...
            if self.cooldown_remaining == 0 and (
                rms <= rms_threshold * self.rearm_ratio
                or (self.enable_peak_rearm and rms <= release_level)
            ):
                self.armed = True
                self.unarmed_peak_rms = 0.0
        ...
        suppress_discontinuous_onset = self._continuity_reset_pending
        self._continuity_reset_pending = False
        is_onset = (
