...
- Mise à jour : `2026-07-29T03:57:56.0599439+04:00`
- Étape : `dual_stream_bass_candidate`
- Statut : `en cours`
- Détail : Le candidat causal à deux représentations est implémenté au commit source `edc39ff9`. Une entrée de 8192 échantillons alimente le chemin normal 4096 et une petite branche 8192→4096 spécialisée MIDI 40–64. La fusion résiduelle frame/onset est neutre après transfert V2.2. Le candidat ajoute 5 730 paramètres (+1,7 %, 342 996 au total), tient 2,81/2,13/2,31 ms p95 en TFLite à 1/2/3 threads et les 257 tests passent. Le smoke P100 est validé : Python 3.12.13, TensorFlow 2.20.0, 25 couches V2.2 transférées, 7 nouvelles couches graves, validation frame F1 0,4667 et onset F1 0,1111 sur 128 exemples, archive et SHA-256 conformes, `locked_test_used=false`. Le train complet P100 `miranacareneandrisoa/guitar-midi-dual-bass-train-edc39ff9` est maintenant `RUNNING` avec 8 époques, 240 000 exemples par époque, 60 000 exemples de validation, les 16 shards et `epoch-08.keras` comme initialisation. Le rééquilibrage grave et l'objectif fondamentale/résonance restent séparés.
...
- 2026-07-29 — **en cours** — `live_ab_adaptive_attack` : Deux représentations simultanées sont implémentées dans un modèle unique : chemin normal 4096 et petite branche grave compressée 8192→4096, fusion résiduelle MIDI 40–64. Initialisation V2.2 neutre confirmée, +5 730 paramètres (+1,7 %), TFLite p95 sous 2,81 ms et 257 tests passants. Smoke P100 validé avec archive/SHA-256 conformes et `locked_test_used=false`. Train complet P100 `guitar-midi-dual-bass-train-edc39ff9` actif : 8 époques, 240 000 exemples/époque, validation 60 000, initialisation `epoch-08.keras`. Sélection et calibration resteront validation-only.
