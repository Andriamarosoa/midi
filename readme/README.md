...
- Mise à jour : `2026-07-29T03:57:11.0463138+04:00`
- Étape : `dual_stream_bass_candidate`
- Statut : `en cours`
- Détail : Le candidat causal à deux représentations est implémenté et poussé au commit `edc39ff9` sur `codex/dual-stream-bass`. Une seule entrée de 8192 échantillons alimente le chemin normal limité aux 4096 échantillons récents et une petite branche 8192→4096 compressée par deux, spécialisée MIDI 40–64. La fusion se fait par résidus appris sur les logits frame/onset, initialisés à zéro ; après transfert, les quatre sorties sont identiques à V2.2 avant apprentissage. Le candidat ajoute 5 730 paramètres (+1,7 %, 342 996 au total). Le TFLite float16 local mesure 2,81/2,13/2,31 ms p95 à 1/2/3 threads, sous le hop de 5,80 ms, et les 257 tests passent. Le smoke P100 `guitar-midi-dual-bass-smoke-edc39ff9` est terminé : Python 3.12.13, TensorFlow 2.20.0, 25 couches V2.2 transférées, seulement les 7 nouvelles couches graves ignorées, validation frame F1 0,4667 et onset F1 0,1111 sur 128 exemples. L'archive fait 17 745 920 octets, SHA-256 `691de8bb0b13ccd0db18df985ca68d1bd6fc2b59faac11b68bbd7de6eebd40c7`, conforme, et `locked_test_used=false`. Le train complet Kaggle de ce seul changement peut maintenant démarrer. Le rééquilibrage grave et l'objectif fondamentale/résonance restent séparés.
...
- 2026-07-29 — **en cours** — `live_ab_adaptive_attack` : Mémoire d'accord insuffisante ; rendu global rejeté. Deux représentations simultanées sont implémentées dans un modèle unique : chemin normal 4096 et petite branche grave compressée 8192→4096, fusion résiduelle MIDI 40–64. Initialisation V2.2 strictement neutre confirmée, +5 730 paramètres (+1,7 %). TFLite float16 p95 2,81/2,13/2,31 ms à 1/2/3 threads ; 257 tests passent. Commit `edc39ff9` poussé. Smoke P100 terminé et validé : frame F1 0,4667, onset F1 0,1111 sur 128 exemples, archive 17 745 920 octets, SHA-256 conforme, `locked_test_used=false`. Étape suivante : train complet Kaggle de ce seul changement, puis sélection validation-only.
