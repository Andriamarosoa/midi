...
```powershell
python -m src.train.check_loader --npz "data\processed\stream\00_BN1-129-Eb_comp_hex.npz"
```

## Entraîner

```powershell
python -m src.train.train_v1 --npz "data\processed\stream\00_BN1-129-Eb_comp_hex.npz" --epochs 30
```
