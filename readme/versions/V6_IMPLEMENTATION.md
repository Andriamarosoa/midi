...
`data/processed/v6_0_active/validation_report.json`.
...
python -m src.v5.external_data `
  --output-dir data\processed\v6_0_active `
...
python -m src.v6.validate_dataset `
  --baseline-manifest data\processed\v5_3_harmonics\manifest.csv `
  --candidate-manifest data\processed\v6_0_active\manifest.csv `
  --output data\processed\v6_0_active\validation_report.json
```
